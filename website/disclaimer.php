...
<head>
    ...
    <title><?php echo $t['disclaimer_title']; ?> — Tortu</title>
...
<body>
    <div class="container">
        ...
        <main class="legal-content">
            <h2><?php echo $t['disclaimer_title']; ?></h2>
            <p><?php echo $t['disclaimer_p1']; ?></p>
            <p><?php echo $t['disclaimer_p2']; ?></p>
            <p><?php echo $t['disclaimer_p3']; ?></p>
